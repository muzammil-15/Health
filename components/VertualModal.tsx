...
const VertualModal: React.FC = ({isModalOpen,setModalOpen,closeModal}: any) => {
...
const Servicesoptions: Services[] = [
  ...
  return (
    <div className={`  ${!isModalOpen ? "hidden" : "flex"} min-h-screen  items-center justify-center `}>
          ...
          <div className="bg-white h-[90vh] p-4 rounded-lg shadow-md w-[80%] md:w-[65%] z-50 overflow-y-scroll">
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-between items-center mt-4 mx-2">
                <h2 className="text-[#111535] text-2xl font-[600]">E-Clinics</h2>
                ...
                {Servicesoptions.map((item, ind) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-center items-start gap-2 ">
                        <h2 className="text-[22px] text-[#111535] font-[600]">General Medicine</h2>
                        <p className="text-[#898B9F] text-[18px] font-[400]">Doctors John William</p>
                        <button className="bg-[#AF2245] text-[#fff] p-2 rounded-md w-[180px]">Continue</button>
                    </div>
                  </div>
                ))}
              </div>
