              ...
              <div className="Reviwcard mx-5 relative bg-[#FFF] rounded-lg">
                <div className="relative ">
                  ...
                  <div className="bg-[#F6F7F9] px-4 py-10">
                    <p className="text-[#111535] text-center text-sm font-normal">
                      {item.desc}
                    </p>
                  </div>
                </div>
                ...
                <h1 className="text-[#111535] text-center mt-5 text-sm font-semibold">
                  {item.title}
                </h1>

                <div className="pb-5">
                  <h1 className="text-[#111535] text-center mt-0 text-sm font-normal">
                    Customer
                  </h1>
                </div>
              </div>
