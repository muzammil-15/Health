              ...
              <div className="">
                <div className="flex flex-col lg:flex-row  gap-5">
                  ...
                  <div className="left lg:w-[80%] flex flex-col">
                    ...
                    <h1 className="text-[24px] text-[#111535] font-[600] mt-3">
                      Children’s Vaccination ( Age: 2 month )
                    </h1>
                    <p className="mt-5 tracking-tight text-[#898B9F] font-normal text-justify text-lg ">
                      The vaccination team will provide two-month-old children
                      immunizations against (IPV, DTaP, Hepatitis B, Hib,
                      Pneumococcal Conjugate, (PVC), and Rota).
                    </p>
                  </div>
                </div>
              </div>
              <p className="mt-5 bg-red-700 bg-opacity-10 tracking-tight text-[#898B9F] p-1 rounded-[8px] font-normal text-justify text-lg">
                Includes Vaccination material, dgloves, alcohol wipes, masks and
                sterilization for the medical team, Vaccination record will be
                updated and stamped.
              </p>
            </div>
          </div>
