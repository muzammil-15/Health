                ...
                <div className='mt-5 flex flex-wrap gap-5 justify-center lg:justify-between align-top'>
                    ...
                    <div className='w-full bg-[#FFF] Shadowbg rounded-[8px] p-3   md:w-[60%] flex flex-wrap gap-5 justify-center '>
                        ...
                        <div className="">
                            ...
                            <h1 className="text-lg text-[#111535] font-[600]">Injection/Home IV therapy</h1>
                            ...
                            The nurse injects a drug or solution directly into the vein or through IV cannula, the nurse will confirm allergy history prior to give IV treatment. <button className='text-[#AF2245]' onClick={()=>handleDetail()}>
                    ...
                    {
                        details&& 
                        <p className='mt-5 bg-red-700 bg-opacity-10 tracking-tight text-[#898B9F] p-1 rounded-[8px] font-normal text-justify text-lg'>Includes : Syringe and IV tube will be brought. Possibility to check allergy from the prescribed medication by taking a drug allergy test. , * solutions and drugs to be injected are not included. , *Instructions: The patient must present a medical prescription that includes the medication name and dosages.</p>
