...
function page() {
    ...
    return (
        <>
            ...
            {/* vitamin-drips herosection  start*/}
            ...
            {/* vitamin-drips herosection enbd */}
            <div className="padding-x">
                ...
                <div className='mt-5 flex flex-wrap gap-5 justify-center lg:justify-between align-top'>
                    ...
                    <div className='w-full bg-[#FFF] Shadowbg rounded-[8px]   p-4 md:w-[60%] flex flex-wrap gap-5 justify-center '>
                            ...
                            <div className="">
                                <div className="flex flex-col lg:flex-row  gap-5">
                                    ...
                                    <div className="left lg:w-[80%] flex flex-col">
                                        <input type='radio' className=' self-end border-[#898B9F] w-[28px]  h-[28px] border-2' />
                                        <h1 className="text-[24px] text-[#111535] font-[600] ">Energy boost</h1>
                                        <p className="mt-5 tracking-tight text-[#898B9F] font-normal text-justify text-lg ">
                                        To restore energy, build protins, support antioxidants, and increase productivity. starting from 1300 SAR 
                            ...
                            <p className='mt-5 bg-red-700 bg-opacity-10 tracking-tight text-[#898B9F] p-1 rounded-[8px] font-normal text-justify text-lg'>Includes vitamin B12, vitamin C, magnesium Sulphate, Potassium chloride, zinc, selenium, l-Carnitine, glutamine, normal saline, multivitamins mixture </p>
